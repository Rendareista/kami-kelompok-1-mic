...
|-------------------|-------|-----------------------|-------------------------------|
| Admin | |Melihat Laporan | |Memasukkan, Edit, Menghapus Data | Memantau laporan hasil penjualan, Edit akun penjual, Memasukkan, Edit, Menghapus Data, Mengedit akun penjual, menghapus yang tidak sesuai dengan perjanjian kerjasama mitra|s
